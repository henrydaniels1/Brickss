          ...
          {["/", "/gallery", "/portfolio", "/contact"].map((path, index) => {
            ...
            return (
              <motion.div
                ...
                className={`font-bold text-black hvr-underline-from-center relative pb-1 cursor-pointer`}>
          ...
          {["/", "/gallery", "/portfolio", "/contact"].map((path, index) => {
            ...
            return (
              <motion.div
                ...
                // }}
                // transition={{ duration: 0.3 }}
                className={`font-bold text-black hvr-underline-from-center relative pb-2 cursor-pointer`}>
                <Link to={path} className='z-10'>
                  {labels[index]}
                </Link>
                {/* <motion.div
