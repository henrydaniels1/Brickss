export const Foot = () => {
  return (
    <div className="px-4  pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen md:px-24 lg:px-8">
      <div className="grid gap-10 row-gap-6 mb-8 mt-8 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        <p className="text-sm text-gray-600">
          © Copyright 2020 Bricks&Steels Inc. All rights reserved.
        </p>
