  ...
  return (
    <div className="relative md:w-[95%] w-full h-[38rem] mx-auto md:h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center z-10">
        <h1 className="text-white lg:text-5xl md:text-[2.8rem] text-[1.7rem] lg:tracking-[1rem] md:tracking-[0.7rem] tracking-[0.13rem] font-bold">Architecture at it&apos;s best</h1>
      </div>
    </div>
  );
}
